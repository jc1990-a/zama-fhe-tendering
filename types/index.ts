...
export type { Tendering } from "./contracts/Tendering";
export { Tendering__factory } from "./factories/contracts/Tendering__factory";
export type { FHETendering } from "./contracts/TenderingFHE.sol/FHETendering";
export { FHETendering__factory } from "./factories/contracts/TenderingFHE.sol/FHETendering__factory";
